...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/robot-slave/Documents/Testovoe/testovoe_venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/robot-slave/Documents/Testovoe/testovoe_venv/bin/deactivate.nu'
